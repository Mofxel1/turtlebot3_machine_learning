...
Simülasyonu Hızlandırmak: Gazebo açıldığında sol panelden Physics menüsüne gidin ve real_time_update_rate değerini 2000 yapın. (Not: Fizik hataları başlarsa bilgisayar hızınıza göre optimize edin).
